          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                var turmaComunicado = aviso.reference.parent?.parent?.id;
                if (turmaComunicado == null) {
                  print('Comunicado sem turma ou caminho inválido: $aviso');
                  return Container(); // Ou qualquer outro tratamento que desejar
                }

                // Verificar se o aluno pertence à mesma turma do comunicado
                if (widget.alunoData?['turma'] == turmaComunicado) {
                  print('Comunicado exibido para o aluno: $aviso');
                  return Card(
                    elevation: 2.0,
                    margin:
                  ...
                  print('Comunicado não exibido para o aluno: $aviso');
                  return Container();
                }
              },
            );
