...
class BoletimScreen extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              _buildExpandableCard('Matemática', FontAwesomeIcons.calculator, [
                ...
                _buildSubjectRow('Março', '7.5', Colors.orange),
                _buildSubjectRow('Abril', '7.5', Colors.orange),
                _buildSubjectRow('Maio', '7.5', Colors.orange),
                _buildSubjectRow('Junho', '7.5', Colors.orange),
                _buildSubjectRow('Julho', '7.5', Colors.orange),
                _buildSubjectRow('Agosto', '7.5', Colors.orange),
                _buildSubjectRow('Setembro', '7.5', Colors.orange),
                _buildSubjectRow('Outubro', '7.5', Colors.orange),
                _buildSubjectRow('Novembro', '7.5', Colors.orange),
                _buildSubjectRow('Dezembro', '7.5', Colors.orange),
              ]),
              ...
              _buildExpandableCard('Espanhol', FontAwesomeIcons.spa, [
                _buildSubjectRow('Janeiro', '9.5', Colors.blue),
                _buildSubjectRow('Fevereiro', '8.0', Colors.green),
                _buildSubjectRow('Março', '7.5', Colors.orange),
                _buildSubjectRow('Abril', '7.5', Colors.orange),
  ...
  Widget _buildExpandableCard(String subject, IconData iconData, List<Widget> subjectRows) {
    return Card(
      elevation: 4,
